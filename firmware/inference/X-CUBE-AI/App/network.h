...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "tinyml_context_model_int8"
...
#define AI_NETWORK_IN_1_CHANNEL     (41)
#define AI_NETWORK_IN_1_SIZE        (41)
#define AI_NETWORK_IN_1_SIZE_BYTES  (41)
