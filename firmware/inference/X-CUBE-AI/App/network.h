...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "nn_model_windowed_quantized"
...
#define AI_NETWORK_IN_1_CHANNEL     (20350)
#define AI_NETWORK_IN_1_SIZE        (20350)
#define AI_NETWORK_IN_1_SIZE_BYTES  (81400)
