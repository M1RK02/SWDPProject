...
enum EnvironmentClass {
  outdoor(0,      'Outdoor',        Color(0xFFFFB300), Icons.wb_sunny),
  indoorNoisy(1,  'Indoor noisy',   Color(0xFFE65100), Icons.volume_up),
  indoorSilent(2, 'Indoor silent',  Color(0xFF1976D2), Icons.home),
  dark(3,         'Full dark',      Color(0xFF37474F), Icons.nightlight_round),
  underground(4,  'Underground',    Color(0xFF6A1B9A), Icons.subway),
